...
const sample = {
    ...
    workExperience: [
        ...
        },
        {
            ...
            description: '• Experienced working in a fast-paced environment by delivering packages to meet quotas'
        }
    ],
    projectExperience: [
        {
            ...
            endDate: 'June 2022',
            description: '• Won ESC Showcase 2022 for Best Legacy team out of over 40 engineering/cs clubs. Won 3rd place in intercollegiate competition for Friends of Amateur Rocketry in the 10,000ft competition.\n• Control cashflow for senior design rocketry parts and personal projects for active members\n• Mentor junior classmates for senior design class with educational workshops'
        },
        {
            id: uuidv4(),
            department: 'Baja SAE',
